    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.process_group is None:
            ...
            self.in_proj = ColumnParallelLinear(self.d_model, d_in_proj * self.world_size, bias=config.bias,
        ...
        if self.process_group is None:
            ...
            self.out_proj = RowParallelLinear(self.d_inner * self.world_size, self.d_model, bias=config.bias,
                                              process_group=self.process_group, sequence_parallel=self.sequence_parallel,
                                              **factory_kwargs)
