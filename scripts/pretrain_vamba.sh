...
run_name="vamba_pretrain_${learning_rate}_${dataset}"
...
accelerate launch --config_file=$config_file --num_machines=1 --num_processes=8 --machine_rank=$NODE_RANK --main_process_ip=$MASTER_ADDR --main_process_port=$MASTER_PORT train/train_vamba.py \
